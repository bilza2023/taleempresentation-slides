...
<SmallBtnToolbar clk={()=>addNewItem(addLines)} icon={icons.BICYCLE} title="Lines" />
...
<SmallBtnToolbar clk={logSlideLocal} icon={icons.PRINTER} title="Download" />
